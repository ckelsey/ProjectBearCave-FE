...
export default class SlideVertical extends Vue {
    ...
    public mounted() {
        ...
        if (!Body.SlideVerticalAnimating) {
            Body.SlideVerticalAnimating = []
        }
        ...
        const base = {
            ...
            complete: () => {
                Body.SlideVerticalAnimating.pop()
                ...
                if (Body.SlideVerticalAnimating.length === 0) {
        ...
        const elIn = Object.assign({}, base, { scaleY: [0, 1] })
        const elOut = Object.assign({}, base, { scaleY: [1, 0] })
        ...
        const run = () => {
            ...
            this.timer = setTimeout(() => {
                Body.SlideVerticalAnimating.push(id)
                ...
                el.style.transformOrigin = this.showing ? `50% 0%` : `50% 100%`
